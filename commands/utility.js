...
const CATALOG = {
    "📥 Media & Downloads": {
        ...
        "play": { d: "Search & download a song as MP3 audio", a: [] },
...
Bot: *${config.botName}*  |  Mode: *${(config.mode || "private").toUpperCase()}*`
    ...
    p: async (ctx) => module.exports.ping(ctx),
...
💾 *Memory:* ${mem} MB`
    ...
    system: async (ctx) => module.exports.info(ctx),
...
*Join here:* ${config.channelUrl}`,
    ...
    menu: async (ctx) => module.exports.help(ctx),
...
`;
    ...
    get: async (ctx) => module.exports.send(ctx),
