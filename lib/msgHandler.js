        ...
        if ((antilinkMode !== "off" && hasLink) || (antiMentionOn && hasMention)) {
          ...
          if (!senderIsAdmin) {
            ...
            if (antilinkMode === "kick" && hasLink) {
              ...
              // track warns per group+user in memory on settings
