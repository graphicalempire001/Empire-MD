...
*Since:* ${new Date(afkData.time).toLocaleTimeString()}`,
                       ...
                       // Only announce the channel on shared media if THIS bot has it enabled.
            if (settings.mediaChannelPromo === true &&
                isGroup &&
                (mek.message.imageMessage || mek.message.videoMessage || mek.message.audioMessage)) {
